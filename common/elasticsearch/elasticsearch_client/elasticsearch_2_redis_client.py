...
class ElasticsearchRedisClient(Elasticsearch):
    ...
    def create(self, index, doc_type, id, body, params=None):
        redis_client.rpush(self.redis_key,
                           json_util.dumps({'op': 'create', 'index': index, 'doc_type': doc_type,
    ...
    def index(self, index, doc_type, body, id=None, params=None):
        redis_client.rpush(self.redis_key,
                           json_util.dumps({'op': 'index', 'index': index, 'doc_type': doc_type,
                                            'body': body, 'id': id, 'params': params}))
    ...
    def update(self, index, doc_type, id, body=None, params=None):
        redis_client.rpush(self.redis_key,
                           json_util.dumps({'op': 'update', 'index': index, 'doc_type': doc_type,
                                            'body': body, 'id': id, 'params': params}))
    ...
    def bulk(self, body, index=None, doc_type=None, params=None):
        redis_client.rpush(self.redis_key,
                           json_util.dumps({'op': 'bulk', 'index': index, 'doc_type': doc_type,
    ...
    def update_by_query(self, index, doc_type=None, body=None, params=None):
        redis_client.rpush(self.redis_key,
                           json_util.dumps({'op': 'update_by_query', 'index': index, 'doc_type': doc_type,
                                            'body': body, 'params': params
                                            }))
    ...
    def delete_by_query(self, index, body, doc_type=None, params=None):
        redis_client.rpush(self.redis_key,
                           json_util.dumps({'op': 'delete_by_query', 'index': index, 'doc_type': doc_type,
                                            'body': body, 'params': params
                                            }))
